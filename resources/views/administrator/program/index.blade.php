                                                    ...
                                                    <div class="modal-content">
                                                        <form method="post">
                                                            ...
                                                            <div class="modal-body text-start">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="">URL</label>
                                                                    <input type="url" name="url" id="url" placeholder="Masukan URL Program" class="form-control">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="modal-content">
                                                <form id="form" method="post">
                                                    ...
                                                    <div class="modal-body text-start">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">URL</label>
                                                            <input type="url" name="url" id="url" placeholder="Masukan URL Program" class="form-control edit-url">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    ...
                    $('#table').DataTable({
                        ...
                        "initComplete":function( settings, json){
                            $('.edit').on('click', function(data){
                                ...
                                let action = `<?= url('administrator/program/edit/${dataID}') ?>`;

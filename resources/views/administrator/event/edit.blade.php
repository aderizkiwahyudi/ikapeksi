                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="row align-items-center">
                                            <div class="col-md-10">
                                                <input type="text" placeholder="Judul" value="{{ $event->title }}" name="title" id="title" class="form-control"/>
                                            </div>
                                            <div class="col-md-2">
                                    ...
                                    <div class="col-md-9 mb-3">
                                        <textarea name="text" class="editor">{{ $event->text }}</textarea>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="bg-white shadow-sm border mb-3">
                                            ...
                                            <div class="p-3">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="mt-2">
                                                        <img src="{{ $event->thumbnail }}" alt="gambar" width="100%"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="bg-white shadow-sm border mb-3">
                                            ...
                                            <div class="p-3">
                                                <div class="form-group mb-0">
                                                    <input type="date" name="start_at" value="{{ $event->start_at }}" id="start_at" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="bg-white shadow-sm border mb-3">
                                            ...
                                            <div class="p-3">
                                                <div class="form-group mb-0">
                                                    <input type="date" name="end_at" value="{{ $event->end_at }}" id="end_at" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="bg-white shadow-sm border mb-3">
                                            ...
                                            <div class="p-3">
                                                <div class="form-group mb-0">
                                                    <input type="text" name="location" value="{{ $event->location }}" placeholder="Enter location event" id="location" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

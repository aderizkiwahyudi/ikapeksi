        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Halaman</h1>
                            <p>Lakukan Perubahan Pada Halaman</p>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="row align-items-center">
                                            <div class="col-md-10">
                                                <input type="text" placeholder="Judul" value="{{ $page->title }}" name="title" id="title" class="form-control"/>
                                            </div>
                                            <div class="col-md-2">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <textarea name="text" class="editor">{{ $page->text }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>

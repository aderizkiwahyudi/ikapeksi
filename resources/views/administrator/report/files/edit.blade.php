                                ...
                                <div class="p-3">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $file->name }}" placeholder="Enter name" name="name" class="form-control"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Thumbnail</label>
                                            <input type="file" name="thumbnail" class="form-control"/>
                                            <div class="mt-2">
                                                <img src="{{ $file->thumbnail }}" width="40%"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="mt-2">
                                                <a href="{{ $file->file }}"><i class="fas fa-file-pdf"></i> Download PDF</a>
                                            </div>
                                        </div>
